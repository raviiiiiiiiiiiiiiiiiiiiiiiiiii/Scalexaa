...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    const updateScrollDir = () => {
      ...
      if (!isOpen) {
        setIsHidden(scrollY > lastScrollY && scrollY > 80);
      }
  ...
  return (
    <nav className={`fixed w-full z-50 bg-white border-b border-gray-100/50 backdrop-blur-md transition-transform duration-300 ease-in-out ${isHidden ? '-translate-y-full' : 'translate-y-0'}`}>
